...
def _fallback_outcome_diff_insight(
    ...
    *,
    ...
    return InsightResult(
        title="",
        insight=(
            f"{winner_label} are {lift:.1f}x more likely to {option_label} "
...
def _validated_outcome_diff_insight(
    ...
    if (
        ...
        or not _outcome_diff_insight_numbers_are_valid(insight.insight, payload)
    ):
        return _fallback_outcome_diff_insight(
            payload,
            reason=(
                insight.error_message
                or "AI insight numbers did not match the source table."
            ),
        )
    return insight
...
def _render_outcome_diff_insight_card(
    ...
    _render_differentiator_source_table_expander(
        sorted_diffs,
        winner_label,
        laggard_label,
        highlight_question_id=diff.question_id,
    )
