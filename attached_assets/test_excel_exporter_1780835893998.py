...
class TestExcelExporter(unittest.TestCase):
    ...
    def test_nps_count_formula_ignores_non_numeric_raw_cells(self) -> None:
        formula = _build_nps_count_formula(
            "Q_NPS_Vendor_A_data",
            9,
            10,
            [],
        ...
        self.assertIn("IFERROR(VALUE(Q_NPS_Vendor_A_data)>=9,FALSE)", formula)
        self.assertIn("IFERROR(VALUE(Q_NPS_Vendor_A_data)<=10,FALSE)", formula)
        self.assertIn("IFERROR(MOD(VALUE(Q_NPS_Vendor_A_data),1)=0,FALSE)", formula)
        self.assertNotIn("--(Q_NPS_Vendor_A_data>=9)", formula)
