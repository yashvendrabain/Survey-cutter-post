...
def render_chat_panel(faq_path: str = _FAQ_PATH_DEFAULT) -> None:
    ...
    # Always-open assistant (no toggle). SVG chat icon reused for the avatar.
    _chat_icon_svg = (
        "data:image/svg+xml;utf8,"
        "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' viewBox='0 0 24 24' "
        "fill='none' stroke='%23CC0000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round'>"
    ...
    st.markdown(
        ...
        #sae-chat-card-anchor + div[data-testid="stVerticalBlockBorderWrapper"]{
          border:1px solid #E3E3E8 !important; border-radius:16px !important;
        ...
        .sae-chat-head .av img{width:20px;height:20px;}
        .sae-chat-head .t1{font-size:16px;font-weight:700;line-height:1.1;}
        .sae-chat-head .t2{font-size:11px;opacity:0.9;margin-top:2px;}
        /* tab pills — allow wrap/scroll so nothing trims in the narrow sidebar */
        #sae-chat-card-anchor + div [data-testid="stTabs"] [data-baseweb="tab-list"]{
          gap:4px; background:#F6F6F8; padding:4px; border-radius:10px;
          flex-wrap:wrap; overflow-x:auto;
        }
        #sae-chat-card-anchor + div [data-testid="stTabs"] [data-baseweb="tab"]{
          border-radius:8px; font-size:11px; font-weight:600; padding:5px 8px; white-space:nowrap;
        }
    ...
    with st.container(border=True):
        st.markdown(
            ...
            f"<div class='av'><img src=\"{_chat_icon_svg}\" alt=\"chat\"/></div>"
