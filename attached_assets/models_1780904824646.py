...
class RankOrderRow:
    ...
    def __post_init__(self) -> None:
        ...
        _require_numeric(self.net_rank_score, "net_rank_score")
        if not 0.0 <= float(self.net_rank_score) <= 100.0:
            raise ValueError("net_rank_score must be between 0 and 100")
