...
def _wvl_build_raw_data_sheet(
    ...
    helper_headers = [
        ...
        "winners_mask_data",
        "laggards_mask_data",
        *[_per_question_pass_data_name(result.question_id) for result in results],
    ]
...
def _wvl_averageifs(data_name: str, question_id: str, cohort_mask_name: str) -> str:
    filter_pairs = _live_filter_criteria_pairs("", question_id)
...
def _wvl_filtered_numeric_formula(metric: str, data_name: str, question_id: str, cohort_mask_name: str) -> str:
    filter_pairs = _live_filter_criteria_pairs("", question_id)
