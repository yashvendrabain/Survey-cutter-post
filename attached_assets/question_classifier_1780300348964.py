...
def _build_question_spec(
    ...
    question = _with_label_pattern_sub_columns(question, raw_column_order)
    ...
    label_pattern_warnings = _label_pattern_warnings(question)
    if label_pattern_warnings:
        possible_role = " | ".join(label_pattern_warnings)
...
def _with_label_pattern_sub_columns(
    question: ParsedQuestion,
    ...
    inferred_sub_columns, warnings = _infer_label_pattern_sub_columns(
        question,
        raw_columns,
    )
...
def _infer_label_pattern_sub_columns(
    question: ParsedQuestion,
    raw_columns: tuple[str, ...],
...
def _label_pattern_warnings(question: ParsedQuestion) -> list[str]:
    prefixes = (
