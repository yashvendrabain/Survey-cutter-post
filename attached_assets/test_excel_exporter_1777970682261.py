...
def make_cross_cut_export_fixture():
    ...
    return results, skips, schema, quality_report, log, cross_results, cross_skips
...
class TestExcelExporter(unittest.TestCase):
    ...
    def test_export_writes_cross_tab_body(self) -> None:
        ...
        self.assertEqual(ws["A8"].value, "Counts")
        self.assertEqual(ws["C9"].value, 1)
        self.assertEqual(ws["C11"].value, 5)
        self.assertEqual(ws["A15"].value, "Row %")
    ...
    def test_export_writes_segment_profile_body(self) -> None:
        ...
        self.assertEqual(ws["A8"].value, "Segment: Q_SEG_1 == 1")
        self.assertEqual(ws["A9"].value, "Filter N: 10")
        self.assertEqual(ws["A10"].value, "Target distribution")
        self.assertEqual(ws["A11"].value, "Code")
    ...
    def test_export_writes_group_comparison_body(self) -> None:
        ...
        self.assertEqual(ws["A8"].value, "Per-segment comparison")
        self.assertEqual(ws["A9"].value, "Segment")
        self.assertEqual(ws["D10"].value, 55)
        self.assertEqual(ws["A13"].value, "Overall")
    ...
    def test_export_writes_expected_vs_realized_body(self) -> None:
        ...
        self.assertEqual(ws["A8"].value, "Expected vs Realized")
        self.assertEqual(ws["A10"].value, "Mean")
        self.assertEqual(ws["D10"].value, -5)
        self.assertEqual(ws["A15"].value, "Paired N: 12")
