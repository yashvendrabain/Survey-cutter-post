...
def _render_output_structure_gate() -> bool:
    ...
    if app.session_state.get("wiz_output_structure"):
        ...
        app.markdown("### Configure your Excel Output Structure")
...
def _render_wizard_step_filters() -> None:
    ...
    with _lf_left:
        ...
        app.markdown(
            ...
            "Pick the questions you want available as slicers below.<br><br>"
            "<b>Custom filter:</b> beyond the standard demographics, you can add a "
            "<b>custom</b> slot where the reader picks <i>any</i> question of their "
            "choice and a value to filter by.</div>",
            unsafe_allow_html=True,
        )
    with _lf_right:
        app.markdown(
            ...
            # CUSTOM filter row: question picker (open dropdown) + value
            ...
            # the open dropdown list of questions, with a faux cursor on the hovered one
            ...
            "<div style='width:130px;padding:7px 10px;border-right:1px solid #EEE;color:#9A7B00;'>Custom value</div>"
            "<div style='flex:1;padding:7px 10px;'>"
            "<span style='display:inline-flex;align-items:center;gap:8px;background:#fff;"
