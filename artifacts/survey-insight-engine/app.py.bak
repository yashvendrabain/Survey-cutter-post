...
def _render_wizard_top_nav() -> None:
    ...
    def _arrow(glyph: str, enabled: bool) -> str:
        color = "#CC0000" if enabled else "#D8DADE"
        return (
            f"<div style='font-size:22px;font-weight:700;color:{color};flex:0 0 auto;"
            f"margin-top:8px;font-family:Arial,sans-serif;'>{glyph}</div>"
        )
